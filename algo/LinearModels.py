...
logger = LoggerFileClass("linear_model")
...
class LinearRegressionWithFeatureSelection:
    ...
    def rfe_approach(self):
        ...
        features.
         """
        logger.add_info_log(
            'Entered class LinearRegressionWithFeatureSelection: rfe_approach function')
        ...
        try:
            ...
            logger.add_info_log("class LinearRegressionWithFeatureSelection : rfe_approach. Model "
                                "Build successfully")

            return lr, x_train_rfe, y_pred_train_rfe, x_test_rfe, y_pred_test_rfe, selected_features_rfe

        except Exception as e:
            logger.add_exception_log(f'class LinearRegressionWithFeatureSelection : rfe_approach. Model '
                                     f'Build failed. Exception {str(e)}')
    ...
    def lassocv(self):
        ...
        """
        logger.add_info_log('Entered class LinearRegressionWithFeatureSelection: lassocv function')
        ...
        try:
            ...
            logger.add_info_log("class LinearRegressionWithFeatureSelection : lassocv. Model "
                                "Build successfully")

            return ls, self.x_train, y_pred_train_lasso, self.x_test, y_pred_test_lasso

        except Exception as e:
            logger.add_exception_log(f'class LinearRegressionWithFeatureSelection : lassocv. Model '
                                     f'Build failed. Exception {str(e)}')
